...
<body>
	<div class="container">
		...
		<div>
			<?
				if($intro) {
					echo '<p>Each problem on this page includes a molecule with two groups or atoms highlighted. Your task is to identify the stereotopic relationship shared by the groups, using either the <a target="_blank" href="http://www.youtube.com/watch?v=WIVJPBBUGsE">Q-test</a> or <a target="_blank" href="http://www.youtube.com/watch?v=facIqMwAFec">symmetry elements</a>. Examine the two- and three-dimensional structures provided, then select a relationship. Immediate feedback will be provided, and you can attempt each problem as many times as you\'d like. Click the button below to begin practicing.</p><p>There are <b>'.$problemCount.'</b> problems currently available in the Stereotopicity Trainer. Want to <a href="submit.html">submit your own problems?</a></p>';
